...
func (this *baseController) display(tpl ...string) {
	...
	this.LayoutSections["head"] = this.moduleName + "/head.html"
	this.LayoutSections["left"] = this.moduleName + "/left.html"
	this.LayoutSections["foot"] = this.moduleName + "/foot.html"
